...
<div class="projects-container">
    ...
    <p class="projects-intro">Welcome to my portfolio of research. Click on any project to learn more about it.</p>
<div class="project-title" onclick="toggleProject('project1')">
    Grammar-driven robotic assembly lines
</div>
...
<div class="project-title" onclick="toggleProject('project2')">
