...
![Dev Workflow](https://raw.githubusercontent.com/stefanieZhao77/stefanieZhao77.github.io/main/assets/images/dev-workflow-obsidian-github-automation-en.png)
...
关注 AI 工作流、软件系统设计与 agent 协作。  
正在构建垂类 AI 产品，同时持续记录技术实践与思考。
